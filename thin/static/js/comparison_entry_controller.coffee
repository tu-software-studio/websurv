...
comparison_entry_controller =
          ...
          switch e.which
            ...
            when 40
              ...
              if comparison_entry_controller.current_input_counter > 0
                inputValue = comparison_entry_controller.current_input[0].value
                tableRow = comparison_entry_controller.current_input[0].parentNode.parentNode
                tableRow.children[comparison_entry_controller.current_group].firstChild.value = tableRow.children[1].firstChild.value[...-1]
                comparison_entry_controller.current_input_counter -= 1
    ...
    update_current_cell: ->
      ...
      if inputValue[comparison_entry_controller.current_input_counter] is undefined
        tableRow.children[comparison_entry_controller.current_group].children[1].innerHTML = "&#x2713;"
      else
        tableRow.children[comparison_entry_controller.current_group].children[1].innerHTML = inputValue[comparison_entry_controller.current_input_counter]
